...
BRANDS = ["Krooning","Alexela","Circle K","Neste","Olerex","JetOil","Terminal Oil","Hepa","GO Oil","Saare Kutus","Premium 7","Eesti Gaas","Texor","Moora R-Jaamad","JetGas OU","Levax JK OU","Eksar-Transoil","Anna Kutus","OBB Kaubanduse OU"]
...
'''
with open('/Users/virgohaan/tanklahinnad-backend/app.py', 'w') as f:
    f.write(content)
print("Salvestatud!")
